...
release = __import__("pprintast").__version__
...
htmlhelp_basename = "pprintastdoc"
...
latex_documents = [
    (master_doc, "pprintast.tex", "pprintast Documentation", "Travis Clarke", "manual")
]
...
man_pages = [(master_doc, "pprintast", "pprintast Documentation", [author], 1)]
